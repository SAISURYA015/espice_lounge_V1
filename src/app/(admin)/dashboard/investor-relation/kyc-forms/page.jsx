...
const KycForms = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      setOpen(false);
      setEditingRow(null);
      setForm({ sno: "", title: "", page: "kyc-forms" });
      setNewFile(null);
    } catch (err) {
      console.error(err);
  ...
  return (
    <>
      ...
      <div className="fixed top-0 p-4 bg-gray-100 border-b w-full flex flex-wrap gap-2 z-10">
        ...
        <span className="text-black">KYC Forms</span>
      </div>

      {/* Table */}
      <div className="p-4 mt-14 w-full">
        <div className="flex justify-between items-center mb-3">
          <h2 className="font-semibold text-lg">KYC Forms</h2>
          <button
            onClick={openAdd}
