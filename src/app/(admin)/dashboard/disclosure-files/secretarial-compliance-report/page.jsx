...
const SecretarialReport = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      setOpen(false);
      setEditingRow(null);
      setForm({ sno: "", title: "", page: "secretarial" });
      setNewFile(null);
    } catch (err) {
      console.error(err);
  ...
  return (
    <>
      ...
      <div className="fixed top-0 p-4 bg-gray-100 border-b w-full flex flex-wrap gap-2 z-10">
        ...
        <span className="text-black">Secretarial Compliance Report</span>
      </div>
...
export default SecretarialReport;
